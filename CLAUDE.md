...
- Team roles: `.claude/agents/*.md` (producer, game-designer, gameplay-engineer, frontend-engineer, ai-engineer, level-designer, qa-engineer, tech-artist, mobile-engineer, publisher, monetization-designer). Procedures: `.claude/skills/{daily-sprint,daily-report,game-conventions,level-authoring,playtest}`.
