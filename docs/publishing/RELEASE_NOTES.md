...
- All 50 levels re-authored on the new rules (walls from level 5, mines from 17, tower kinds unchanged); star clocks re-measured with the reference player; enemy AI and the reference bot play the lane model; lesson lines rewritten in EN/AZ/RU/TR. Store screenshots were re-rendered the same day (`0e0ee66`) and are re-rendered once more on build 6 before the store upload (`LAUNCH_CHECKLIST.md` G10 / A11 / R3).
- **Build 6 (2026-09-24, still 1.0.0, `ac41e5d`):** the tutorial band was rebuilt for first-time players on rules v3 — level 1 (`ee5aab0`, LV-13), levels 2 / 4 / 6 / 7 / 8 / 13 (`9a2111a`, BUG-13), levels 3 and 8 again (`f4a95e5`, LV-15) — so the naive first-time line (stream to the nearest tower every 4 s, never stop) wins levels 1–8 at 20/20; a **stalemate hint** — "Stalemate — stop the stream and hit from another side" — appears once per link when a player stream lands nothing for 8 s against an opposing stream (`acf0789`, FE-1; four languages; not on level 1); an "Empty — let the tower grow" hint on a 0-soldier tap (BUG-10); readability pass — dashed 2 px guide lines, ink-outlined enemy ribbons (`35ee108`, ART-7); a full tower now upgrades under fire (`b75a618`, BUG-11); the reference bot grows its home first against two or more enemy towers and budgets artillery (`e81b5a0`, AI-6 / AI-7 / AI-9); all 50 star clocks re-derived from 20-seed medians (`scripts/reclock.ts`). Android `versionCode` / iOS build number 6. The "What's new" texts above are unchanged: nothing here is a player-facing feature beyond the tutorial and the hint.
...
- **Build 6 (2026-09-24, versiya 1.0.0 qalır, `ac41e5d`):** qaydalar v3 üçün ilk dəfə oynayanlara dərs bandı yenidən qurulub — 1-ci səviyyə (`ee5aab0`, LV-13), 2 / 4 / 6 / 7 / 8 / 13 (`9a2111a`, BUG-13), 3 və 8 yenidən (`f4a95e5`, LV-15) — sadə oyunçu xətti (hər 4 saniyədə ən yaxın qülləyə axın, heç vaxt dayandırmadan) 1–8-i 20/20 udur; **pat ipucu** — "Pat vəziyyəti — axını dayandır, başqa tərəfdən vur" — oyunçunun axını 8 saniyə heç nə endirmirsə və qarşıdan düşmən axını gəlirsə hər xətt üçün bir dəfə göstərilir (`acf0789`, FE-1; dörd dil; 1-ci səviyyədə yox); 0 əsgərli qülləyə toxunanda "Əsgər yoxdur — qala böyüsün" ipucu (BUG-10); oxunaqlıq keçidi — qırıq-qırıq 2 px bələdçi xətlər, mürəkkəb konturlu düşmən lentləri (`35ee108`, ART-7); dolu qüllə atəş altında da təkmilləşir (`b75a618`, BUG-11); istinad botu iki və daha çox düşmən qülləsinə qarşı əvvəl evini böyüdür, topları büdcə ilə oynayır (`e81b5a0`, AI-6 / AI-7 / AI-9); bütün 50 ulduz vaxtı 20 seed medianından yenidən çıxarılıb (`scripts/reclock.ts`). Android `versionCode` / iOS build nömrəsi 6. Yuxarıdakı "Yeniliklər" mətnləri dəyişməyib.
