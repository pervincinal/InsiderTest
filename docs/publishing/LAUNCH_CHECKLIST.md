...
| G17 | Privacy policy URL (policy v2.0) | done (page, W5) / needs stakeholder (entry, after W3) | `https://pervincinal.github.io/InsiderTest/privacy.html` — resolves once GitHub Pages is enabled (W3) |
...
| A16 | Support URL, marketing URL, privacy policy URL (policy v2.0), copyright line | marketing, support and privacy URLs done (Pages, pending W3) / needs stakeholder (contact e-mail in the support page, copyright name) | Support `https://pervincinal.github.io/InsiderTest/support.html`, privacy `…/privacy.html`, marketing `…/` |
