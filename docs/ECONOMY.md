...
Assumptions: ~4 levels per day (≈ 6 attempts), 2.2★ average on first clear, two ×2-gold ads per day, daily chest every day, 40 levels in ≈ 12 days. **Daily challenge (added 2026-09-18):** available from day 3 (level 8 is cleared at the end of day 2 at 4 levels/day), played *and won* on **70 % of active days**, **2.2★ average** → 52 gold + 5 crystals per win, **36.4 gold + 3.5 crystals per active day**; 1 / 4 / 10 eligible days at the 10 / 20 / 40-level checkpoints. Daily reward, chest and ad figures are unchanged.
...
| After 40 levels (~day 12) | ≈ 2 364 (880 stars, 530 ads, 480 daily, 120 replays, **364 challenge**) | ≈ 370 (150 milestones, 40 bands, 60 chest, 25 daily, 60 achievements, **35 challenge**) | 15 boosters + one track maxed (1 100) + production to tier 2 (550) + a 5-step track to tier 2 (180); 2–3 skins + spare continues |
...
| After 40 levels (day 12) | 10 | 7 | **364** | **35** | 2 000 → **2 364** (+18 %) | 335 → **370** (+10 %) |
...
- **Crystals (+10 % over the campaign, +39 % in steady state, from a low base).** Continues (10) and skips (30) are frustration valves, not a progression product; two daily wins ≈ one continue, six ≈ one skip — a fair rate for a player who is *winning* daily challenges. Skins at 100–120 move from one per ≈ 12 days to one per ≈ 9 days in steady state; the full shop (1 270) still takes ≈ 10 weeks after the campaign, so cosmetics keep their long-tail role. The Starter Pack claim "400 crystals ≈ 10 days of free earnings" stays true in gold terms (2 364 / 12 ≈ 197 gold a day → 2 000 gold ≈ 10 days). **Keep skins at 80–200, continue at 10, skip at 30, chest at 60.**
...
### 6.2 Daily challenge LiveOps (proposals — nothing here is in `catalog.ts` yet)
...
|---|---|---|
| **$2.99** Starter Pack | 400 crystals + 400 gold + Bronze helmet | 4 shop skins, **or** 2 000 gold (≈ 2 full tracks), **or** 40 continues; ≈ 10 days of free earnings (still true with the daily challenge: ≈ 197 gold a day over the campaign) |
| **$3.99** Remove Ads | no interstitials + 50 crystals | ~1 continue/skip; the purchase is the comfort, not the crystals |
| **$9.99** Premium | no interstitials + 600 crystals + 2 exclusive skins + −10 % boosters | 3 000 gold-equivalent (55 % of the tree) or 5 skins; free + premium after the campaign ≈ 2 364 gold and 970 crystals |
