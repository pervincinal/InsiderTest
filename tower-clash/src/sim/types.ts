...
export type SimEvent =
  ...
  | { type: 'unitDied'; x: number; y: number; owner: Owner; cause: 'clash' | 'artillery' | 'mine'; roadId: string } // roadId: the lane it died on (BUG-14: the play screen reads clash deaths per lane)
